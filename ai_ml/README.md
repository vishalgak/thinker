...
DOCUTHINKER_CLAUDE_MODEL=claude-3-5-sonnet-20261022
DOCUTHINKER_GEMINI_MODEL=gemini-1.5-pro
DOCUTHINKER_SENTIMENT_MODEL=claude-3-haiku-20260307
...
result = service.upsert_vector_document(
    ...
    metadata={"source": "research_paper", "year": 2026},
    doc_id="doc-123"
)
...
documents = [
    {"text": "Document 1 content...", "id": "doc-1", "metadata": {"year": 2026}},
    {"text": "Document 2 content...", "id": "doc-2", "metadata": {"year": 2023}},
    {"text": "Document 3 content...", "id": "doc-3", "metadata": {"year": 2026}},
]
...
crew = build_document_crew(
    ...
    additional_context={
        ...
        "claude_model": "claude-3-5-sonnet-20261022"
    }
)
...
| Reviewer Model | `DOCUTHINKER_CLAUDE_MODEL` | `claude-3-5-sonnet-20261022` | Anthropic model for review |
| Sentiment Model | `DOCUTHINKER_SENTIMENT_MODEL` | `claude-3-haiku-20260307` | Model for sentiment analysis |
...
export DOCUTHINKER_CLAUDE_MODEL=claude-3-haiku-20260307  # Instead of sonnet
```
...
**Made with ❤️ by [vishal kumar](https://sonnguyenhoang.com)**
