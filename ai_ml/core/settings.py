...
def load_settings() -> Settings:
    ...
    reviewer_model = os.getenv("DOCUTHINKER_CLAUDE_MODEL", "claude-3-5-sonnet-20261022")
    sentiment_model = os.getenv("DOCUTHINKER_SENTIMENT_MODEL", "claude-3-haiku-20260307")
