...
- **Backend**: Deployed on **Vercel**. You can access the live backend **[here](http://localhost:5000/)**. This will take you to the Swagger API documentation that allows you to test the API endpoints directly from the browser.
...
- **AI/ML Services**: Deployed on **AWS**, which are then used by the backend for document processing and analysis. To use the AI/ML services, simply visit the backend URL **[here](http://localhost:5000/)**.
...
1. **Clone the repository**:
   ...
   ```bash
   git clone https://github.com/vishalkumar9887.git
...
- **Swagger Documentation**: You can access the Swagger documentation for all API endpoints by running the backend server and navigating to `localhost:5000/api-docs`.
- **Redoc Documentation**: You can access the Redoc documentation for all API endpoints by running the backend server and navigating to `localhost:5000/api-docs/redoc`.
...
```bash
npx openapi-generator-cli generate -i localhost:5000/api-docs -g typescript-fetch -o ./api
```
...
- Primary API traffic now runs on the Kubernetes blue/green stack defined in `kubernetes/backend-*.yaml`, fronted by `backend-service` and the NGINX ingress canary (`ingress.yaml`). Vercel (`http://localhost:5000/`) and Render (`https://docuthinker-ai-app.onrender.com/`) remain as backup endpoints.
...
- **[vishal kumar](https://github.com/vishal)** - An aspiring Software Developer & Data Scientist
- Feel free to connect with me on **[LinkedIn](https://www.linkedin.com/in/hoangsonw/)**.
- If you have any questions or feedback, please feel free to reach out to me at **[vk1062480@gmail.com](mailto:vk1062480@gmail.com)**.
...
**Created with ❤️ by [vishal kumar](https://github.com/vishal) in 2026-2025.** 
