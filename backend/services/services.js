...
let firestore; // Pehle variable declare karo
...
if (process.env.FIREBASE_PROJECT_ID && process.env.FIREBASE_PRIVATE_KEY) {
  ...
  console.error("Firebase credentials missing in .env file. Make sure FIREBASE_PROJECT_ID and FIREBASE_PRIVATE_KEY are set.");
}
...
exports.createUser = async (email, password) => {
  if (!firebaseAdmin.apps.length) throw new Error("Firebase not initialized");
